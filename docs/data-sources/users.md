...
- `project_accesses` (Attributes Set) The set of project roles for this identity, including each project and its role. (see [below for nested schema](#nestedatt--users--project_accesses))

...
- `project_accesses` (Attributes Set) The set of project roles for this identity, including each project and its role. (see [below for nested schema](#nestedatt--service_accounts--project_accesses))
...
- `role` (String) The role assigned in the project.
